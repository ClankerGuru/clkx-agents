        ...
        given("OpenCode.registerTasks") {
            ...
            `when`("tasks are registered") {
                ...
                then("tasks have correct descriptions") {
                    ...
                    val createTask = project.tasks.findByName(OpenCode.TASK_AGENT_CREATE)!!
                    createTask.description shouldBe "Create an OpenCode agent"
                    ...
                    val prTask = project.tasks.findByName(OpenCode.TASK_PR)!!
                    prTask.description shouldBe "Review a pull request with OpenCode"
                    ...
                    val ghRun = project.tasks.findByName(OpenCode.TASK_GITHUB_RUN)!!
                    ghRun.description shouldBe "Run OpenCode GitHub action"
                }
                ...
                then("tasks have correct types") {
                    ...
                    val sessDelTask = project.tasks.findByName(OpenCode.TASK_SESSION_DELETE)!!
                    sessDelTask.shouldBeInstanceOf<OpenCodeSessionDeleteTask>()
                    ...
                    val ghInstallTask = project.tasks.findByName(OpenCode.TASK_GITHUB_INSTALL)!!
                    ghInstallTask.shouldBeInstanceOf<OpenCodeGithubInstallTask>()
